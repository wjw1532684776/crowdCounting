...
if __name__ == '__main__':
    ...
    start_epoch = 0
    checkpoint_filename = f'CSRNet_{args.dataset_name}_{epochs}epoch_{learning_rate}lr_{batch_size}bs.pth'    # model_name i.e. 'MCNN_ShanghaiTechA_1000epoch_1e-05lr_16bs.pth'
